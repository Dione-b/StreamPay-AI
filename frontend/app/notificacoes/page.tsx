...
export default function NotificacoesPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 to-blue-900 p-8">
      <h1 className="text-3xl font-bold text-cyan-400 mb-8">Notificações</h1>
      <div className="bg-slate-800/50 rounded-lg p-6">
        {loading && <p className="text-cyan-300">Carregando notificações...</p>}
        {!loading && notificacoes.length === 0 && <p className="text-gray-400">Nenhuma notificação encontrada.</p>}
